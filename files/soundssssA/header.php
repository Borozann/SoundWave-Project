...
<li class="header-link" style="margin-top:9px"><a href="../../soundssssA/loja.php">Loja</a></li>
      
<li class="header-link" style="margin-top:9px"><a href="../../soundssssA/carrossel.php">Promoções</a></li>
      
<li class="header-link" style="margin-top:9px"><a href="../../soundssssA/sobre_nos.php">Sobre Nós</a></li>
      
      
      
<li class="header-link" style="margin-top:9px"><?php if (isset($_SESSION['admin']) && $_SESSION['admin'] == true) { ?>
        <a href="dashboard_permanete.php">DashBoard</a>
      <?php } ?></li>
...
<li><a href="carts/see_cart.php" class="button-shop" style="margin-right:20px; margin-left:20px;" src="/img/carrinho.png"> 
